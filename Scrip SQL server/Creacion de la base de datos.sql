...
CREATE TABLE CONTABILIDAD --  LLEVARA EL CONTROL DE INGRESOS Y EGRESOS 
(
ID_CONTABILIDAD SMALLINT IDENTITY  NOT NULL, --IDENTIFICADOR DE TABLA
ID_HUERTA  TINYINT NOT NULL, -- INDENTIFICADOR DE HUERTA 
FECHA_INICIO DATE NOT NULL, --FECHA DE INICIO DE CORTE DE CAJA
FECHA_FINAL DATE NOT NULL, --FECHA FINAL DEL CORTE DE CAJA
CAPITAL MONEY  NOT NULL, -- DINERO QUE SE ENCUENTRA 
INGRESO MONEY  NOT NULL DEFAULT 0,--  INGRESO POR SEMANA
EGRESO  MONEY NOT NULL ,--DINERO QUE SALE DE CAJA, PAGOS PRESTAMPS ETC.
CONSTRAINT ID_CONTABILIDAD_PK PRIMARY KEY  (ID_CONTABILIDAD),
CONSTRAINT ID_HUERTA_FK_CONTABILIDAD FOREIGN KEY (ID_HUERTA) REFERENCES HUERTA (ID_HUERTA)
);

CREATE TABLE OTROS_GASTOS --PERMITIRA LLEVAR EL CONTRO DE GASTOS COMO PRESTAMOS A EMPLEADOS O RETIROS PARA USOS VARIOS
(
ID_GASTO SMALLINT IDENTITY  NOT NULL, --IDENTIFICADOR DE TABLA
ID_HUERTA  TINYINT NOT NULL, -- INDENTIFICADOR DE HUERTA 
OTROS_GASTOS MONEY NOT NULL DEFAULT 0, --PERMITIRA PONER GASTOS EXTRAS O DINERO TOMADO
DESCRIPCION VARCHAR (200), --PERMITIRA PONER UNA PEQUE;A DESCRIPCION DE LOS GASTOS
CONSTRAINT ID_GASTOS_PK PRIMARY KEY  (ID_GASTO),
CONSTRAINT ID_HUERTA_FK_GASTO FOREIGN KEY (ID_HUERTA) REFERENCES HUERTA (ID_HUERTA)
);

CREATE TABLE OTROS_INGRESOS--LLEVAR EL CONTROL DE CORTES DE SUGUNDA O INGRESOS COMO PAGOS DE EMPLEADOS ETC...
(
ID_INGRESO SMALLINT IDENTITY  NOT NULL, --IDENTIFICADOR DE TABLA
ID_HUERTA  TINYINT NOT NULL, -- INDENTIFICADOR DE HUERTA 
OTROS_INGRESOS MONEY NOT NULL DEFAULT 0, --PERMITIRA PONER GASTOS EXTRAS O DINERO TOMADO
DESCRIPCION VARCHAR (200), --PERMITIRA PONER UNA PEQUE;A DESCRIPCION DE LOS GASTOS
CONSTRAINT ID_INGRESO_PK PRIMARY KEY  (ID_INGRESO),
CONSTRAINT ID_HUERTA_FK_INGRESO FOREIGN KEY (ID_HUERTA) REFERENCES HUERTA (ID_HUERTA)
);
...
ALTER TABLE HUERTA ADD CAPITAL MONEY NOT NULL;--PERMITIRA SABER LA CANTIDAD EN  DE DINERO DISPONIBLE...
ALTER TABLE HUERTA DROP COLUMN INGRESOS;
ALTER TABLE HUERTA DROP COLUMN EGRESOS;
ALTER TABLE DETALLE_EMPLEADOS_DIA ADD ESTADO_TRABAJO CHAR (1) DEFAULT 0; --PERMITE LLEVAR EL CONTROL DE SI TRABAJO POR LA MANANA "0" POR LA TARDE "1" O DIA COMPLETO "2"
ALTER TABLE EMPLEADOS ADD SALDO_FAVOR MONEY NOT NULL DEFAULT 0; --PERMITIRA SABER CUANTO SE LE DEBE A CADA  EMPLEADO
ALTER TABLE EMPLEADOS ADD SALDO_CONTRA MONEY NOT NULL DEFAULT 0;-- PERMITIRA SABER SI EL EMPLEADO LE DEBE ALGUN PRESTAMO A LA HUERTA 
ALTER TABLE CONTABILIDAD DROP COLUMN OTROS_GASTOS;
ALTER TABLE CONTABILIDAD DROP COLUMN DESCRIPCION ;